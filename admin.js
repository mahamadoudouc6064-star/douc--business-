...
document.addEventListener(
    ...
    async function () {
        ...
        // Afficher les catégories immédiatement
        displayCategories();
...
// =====================================================
// CHARGER LES CATEGORIES DEPUIS SUPABASE
// =====================================================

async function loadCategories() {

    // Les catégories sont déjà affichées
    // par displayCategories().
    ...
    try {
        ...
        if (error) {
            ...
            console.warn(
                "Catégories Supabase non accessibles :",
                error.message
            );

            // On garde les catégories
            // par défaut.
